...
void FaceAttendance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FaceAttendance *_t = static_cast<FaceAttendance *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject FaceAttendance::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_FaceAttendance.data,
      qt_meta_data_FaceAttendance,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FaceAttendance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FaceAttendance.stringdata0))
        return static_cast<void*>(const_cast< FaceAttendance*>(this));
