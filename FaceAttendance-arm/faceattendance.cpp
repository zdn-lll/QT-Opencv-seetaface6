...
//    mmp = mmp.scaledToWidth(ui->vdieoLb->width());
    ...
    cascade.detectMultiScale(srcImgae, faceRects, 1.1,3,0,cv::Size(150,150));
    ui->headpicLb->show();
...
//            QByteArray byte((const char*)buf.data(), buf.size());
            ...
            stream.setVersion(QDataStream::Qt_5_7); // 指定数据流版本
...
void FaceAttendance::timer_connect()
{
    // 连接服务器
    qDebug() << "linking...";
    msocket.connectToHost("192.168.5.27",9999);
}
